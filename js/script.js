...
//8
var l=+prompt('Введить длину кола:');
var p=+prompt('введить периметр квадрата:');
var r=l/(2*3.14)

if (r=p/4)
prompt('коло можливо вписати в квадрат');
else alert('коло не можливо вписати в квадрат');

//9
var l=+prompt(' 2+2 буде: 2 або 6 або 4');
var p=+prompt('2*3 буде: 6 або 2 або 5');
var r=+prompt('6-5 буде: 3 або 2 або 1');
if (l==4 && p==6 && r==1)
  alert('ви набрали 6 балів');
else alert('ви допустили помилку в разрахунках');
